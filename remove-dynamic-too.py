...
# 1. Fix cabal.project.local (remove -dynamic-too)
...
# 2. Update build-wasm.sh to clear the Cabal store
...
print("[HRSM] Removed '-dynamic-too' and configured build script to clear Cabal store.")
