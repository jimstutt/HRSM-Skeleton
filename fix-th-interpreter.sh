...
echo "[HRSM] Enabling external interpreter for Template Haskell..."
...
# Enable external interpreter for Template Haskell (required for cross-compilation)
cabal build frontend-wasm-exe \
  ...
  --with-interpreter="wasmtime run --dir=$DIR"
